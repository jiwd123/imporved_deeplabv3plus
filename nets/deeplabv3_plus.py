...
class DeepLab(nn.Module):
    def __init__(self, num_classes, backbone="mobilenet", pretrained=True, downsample_factor=16):
        ...
        # self.sp = nn.PixelShuffle(4)
        # self.pixelshuconv = nn.Sequential(
        #     nn.Conv2d(256, num_classes*16, 1, stride=1),
        #     nn.BatchNorm2d(num_classes*16),
        #     nn.PixelShuffle(4),
        #     nn.ReLU(inplace=True),
        # )
    ...
    def forward(self, x):
        ...
        #x = self.cat_conv1(torch.cat((x1,x2),dim=1))
